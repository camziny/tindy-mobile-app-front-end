...
type CreateCategoryRouteTypes = RouteProps<
...
const CreateCategoryScreen = () => {
  ...
  const manuallyTriggerRevalidation = () => {
  ...
  const createNewCategory = async () => {
    try {
      ...
      console.log("After mutate in createNewCategory");
  ...
  const deleteCategory = async () => {
    try {
      ...
      console.log("Before mutate in deleteCategory");

      await mutate(BASE_URL + "categories");
      manuallyTriggerRevalidation();

      console.log("After mutate in deleteCategory");
